...
inline constexpr ImU32
    DestructiveButton = IM_COL32(0x8b, 0x0, 0x0, SDL_ALPHA_OPAQUE),
    DestructiveButtonActive = IM_COL32(0xb2, 0x22, 0x22, SDL_ALPHA_OPAQUE),
    DestructiveButtonHover = IM_COL32(0xdc, 0x14, 0x3c, SDL_ALPHA_OPAQUE),
