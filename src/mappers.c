                              ...
                              struct aldo_snapshot *snp)
{
    ...
    fill_pattern_table(aldo_arrsz(vsp->pattern_tables.left),
                       vsp->pattern_tables.left, &bv);
    bv.mem += bv.size;
    ++bv.ord;
    fill_pattern_table(aldo_arrsz(vsp->pattern_tables.right),
                       vsp->pattern_tables.right, &bv);
    b->ptstale = false;
}
