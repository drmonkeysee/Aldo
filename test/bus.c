...
static void copy(void *ctx)
{
    ...
    uint8_t dest[4];
    auto count = aldo_bus_copy(b, 0x0, aldo_arrsz(dest), dest);
...
static void copy_partial_bank(void *ctx)
{
    ...
    uint8_t dest[4];
    auto count = aldo_bus_copy(b, 0x1, aldo_arrsz(dest), dest);
...
static void copy_end_of_bank(void *ctx)
{
    ...
    uint8_t dest[4];
    auto count = aldo_bus_copy(b, 0x3, aldo_arrsz(dest), dest);
...
static void copy_past_bank(void *ctx)
{
    ...
    auto count = aldo_bus_copy(b, 0x4, aldo_arrsz(dest), dest);
...
static void copy_wrong_addr(void *ctx)
{
    ...
    uint8_t dest[] = {0xff, 0xff, 0xff, 0xff};
    auto count = aldo_bus_copy(b, 0x40, aldo_arrsz(dest), dest);
    ct_assertequal(0u, count);
    ct_assertequal(0xffu, dest[0]);
}
